...
export function getButtonStyles({
  ...
  const variantStyles = {
    ...
    shadow: {
      primary:
        "gradient-primary text-primary-foreground shadow-glow hover:shadow-none hover:opacity-95",
      secondary:
        "bg-secondary text-secondary-foreground shadow-sm hover:shadow-none hover:bg-secondary/90",
      success: "gradient-success text-white shadow-glow hover:shadow-none hover:opacity-95",
      error:
        "bg-destructive text-destructive-foreground shadow-sm hover:shadow-none hover:bg-destructive/90",
    ...
    dashed: {
      ...
      secondary:
        "border border-dashed border-input bg-muted/20 text-muted-foreground hover:bg-muted/40",
      success: "border border-dashed border-success text-success bg-success/5 hover:bg-success/15",
      error:
        "border border-dashed border-destructive text-destructive bg-destructive/5 hover:bg-destructive/15",
